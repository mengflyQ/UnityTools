...
namespace ShaderWeaver
{
    ...
    public class SWShaderCreaterSpriteLight : SWShaderCreaterSprite
    {
        ...
        {
            StringAddLine("\t\t[HDR]_Emission (\"Emission\", Color) = (0,0,0,0)");
            base.PropertyField();
        }
        protected override void PropertyDeclare()
        {
            StringAddLine("\t\t\tfixed4 _Emission;");
        ...
        {
            StringAddLine("\t\t\t#pragma surface surf Standard vertex:vert  nofog nolightmap nodynlightmap keepalpha");
