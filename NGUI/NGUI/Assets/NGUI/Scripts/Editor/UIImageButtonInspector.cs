namespace NGUIEditor
{
	...
	public class UIImageButtonInspector : Editor
	{
		...
		{
			EditorGUILayout
			   .HelpBox("Image Button component's functionality is now a part of UIButton. You no longer need UIImageButton.",
			...
			if (GUILayout.Button("Auto-Upgrade"))
			{
				...
				if (btn == null)
				{
					...
					NGUISprite sp                   = btn.tweenTarget.GetComponent<NGUISprite>();
