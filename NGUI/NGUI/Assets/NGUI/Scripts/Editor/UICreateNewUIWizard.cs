namespace NGUIEditor
{
	...
	public class UICreateNewUIWizard : EditorWindow
	{
		...
		void OnGUI()
		{
			...
			EditorGUILayout
			   .HelpBox("This tool has become obsolete with NGUI 3.0.6. You can create UIs from the NGUI -> Create menu.",
			            MessageType.Warning);
		}
		...
		{
			NGUIPanel p = NGUITools.CreateUI(type == CameraType.Advanced3D, NGUISettings.layer);
