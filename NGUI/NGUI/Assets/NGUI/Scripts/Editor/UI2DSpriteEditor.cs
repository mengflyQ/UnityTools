namespace NGUIEditor
{
	...
	[CustomEditor(typeof(NGUI2DSprite), true)]
	public class UI2DSpriteEditor : UIBasicSpriteEditor
	{
		NGUI2DSprite mSprite;

		protected override void OnEnable()
		{
			base.OnEnable();
			mSprite = target as NGUI2DSprite;
		}
		...
		protected override bool ShouldDrawProperties()
		{
			...
			if (fa.boolValue != before) (target as NGUIWidget).drawRegion = new Vector4(0f, 0f, 1f, 1f);

			if (fa.boolValue)
			{
				EditorGUILayout
				   .HelpBox("Note that Fixed Aspect mode is not compatible with Draw Region modifications done by sliders and progress bars.",
				            MessageType.Info);
			}
		...
		public override bool HasPreviewGUI()
		{
			return (Selection.activeGameObject == null || Selection.gameObjects.Length == 1) &&
			       (mSprite                          != null)                                &&
			       (mSprite.mainTexture as Texture2D != null);
		}
		...
		public override void OnPreviewGUI(Rect rect, GUIStyle background)
		{
			if (mSprite != null && mSprite.sprite2D != null)
			{
				...
				if (tex != null)
					NGUIEditorTools.DrawSprite(tex, rect, mSprite.color, mSprite.sprite2D.textureRect, mSprite.border);
			}
		}
	}
}