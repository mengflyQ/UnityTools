namespace NGUIEditor
{
    ...
    static public class NGUIMenu
    {
        ...
        static void AddFont()
        {
            var path = EditorUtility.SaveFilePanelInProject("Save As", "New Font.asset", "asset", "Save font as...",
        ...
        {
            var path = EditorUtility.SaveFilePanelInProject("Save As", "New Atlas.asset", "asset", "Save atlas as...",
                                                            NGUISettings.currentPath);
        ...
        {
            NGUIPanel panel = NGUISettings.AddPanel(SelectedRoot());
        ...
        {
            NGUIPanel panel = NGUISettings.AddPanel(SelectedRoot());
            if (panel == null) panel = NGUIEditorTools.SelectedRoot(true).GetComponent<NGUIPanel>();
        ...
        {
            if (NGUIRoot.list.Count == 0 || NGUICamera.list.Size == 0) return true;
            foreach (NGUICamera c in NGUICamera.list)
        ...
        //static public void Add1 () { AddIfMissing<NGUIAnchor>(); }

        //[MenuItem("NGUI/Attach/Anchor", true)]
        //static public bool Add1a () { return !Exists<NGUIAnchor>(); }

        //[MenuItem("NGUI/Attach/Stretch (Legacy)", false, 7)]
        //static public void Add2 () { AddIfMissing<NGUIStretch>(); }

        //[MenuItem("NGUI/Attach/Stretch (Legacy)", true)]
        //static public bool Add2a () { return !Exists<NGUIStretch>(); }
        ...
        {
            return (Selection.activeGameObject != null) &&
                   (Selection.activeGameObject.GetComponent<NGUIWidget>() != null);
        }
        ...
        {
            return (Selection.activeGameObject != null) &&
                   (Selection.activeGameObject.GetComponent<AudioSource>() != null);
        }
        ...
        // [MenuItem("NGUI/Open/NGUIFont Maker",               false, 9)]
        // [MenuItem("Assets/NGUI/Open NGUIFont Maker", false, 0)]
        // static public void OpenNGUIFontMaker()
        // {
        //     ScriptableObject scriptableObject = ScriptableObject.CreateInstance<NGUIFont>();
        //     AssetDatabase.CreateAsset(scriptableObject, "Assets/Font/NGUIFont.asset");
        //     AssetDatabase.SaveAssets();
        ...
        {
            return NGUIWidget.showHandlesWithMoveTool && NGUISettings.colorMode != NGUISettings.ColorMode.Blue;
        }
        ...
        {
            return NGUIWidget.showHandlesWithMoveTool && NGUISettings.colorMode != NGUISettings.ColorMode.Orange;
        }
        ...
        {
            return NGUIWidget.showHandlesWithMoveTool && NGUISettings.colorMode != NGUISettings.ColorMode.Green;
        }
        ...
        static public void SwitchTo2D()
        {
            ...
            for (int i = 0; i < colliders.Length; ++i)
            {
                ...
                NGUICamera cam = NGUICamera.FindCameraForLayer(go.layer);
                if (cam == null) continue;
                if (cam.eventType == NGUICamera.EventType.World_3D) continue;
                if (cam.eventType == NGUICamera.EventType.World_2D) continue;

                cam.eventType = NGUICamera.EventType.UI_2D;
			...
			bc.center = center;
                ...
                NGUIPanel p = NGUITools.FindInParents<NGUIPanel>(go);
        ...
        static public void SwitchTo3D()
        {
            ...
            for (int i = 0; i < colliders.Length; ++i)
            {
                ...
                cam.eventType = NGUICamera.EventType.UI_3D;
        ...
        static public void AlignSVToUI()
        {
            var go = Selection.activeGameObject != null
                         ...
                         : NGUICamera.list.Buffer[0].gameObject;
        ...
        static public bool AlignSVToUICheck()
        {
            ...
            if (NGUICamera.list.Size == 0) return false;
