namespace NGUIEditor
{
	...
	public class ComponentSelector : ScriptableWizard
	{
		...
		static public void Draw(string                   buttonName, INGUIAtlas atlas, OnSelectionCallback cb,
		                        bool                     editButton,
		...
		static public void Draw(INGUIAtlas               atlas, OnSelectionCallback cb, bool editButton,
		                        params GUILayoutOption[] options)
		{
			Draw(atlas as NGUIAtlas, cb, editButton, options);
		}

		static public void Draw(INGUIFont                font, OnSelectionCallback cb, bool editButton,
		                        params GUILayoutOption[] options)
		{
		...
		static public void Show<T>(OnSelectionCallback cb)
		{
		...
		bool DrawObject(Object obj)
		{
			...
			GUILayout.BeginHorizontal();
			{
				...
				retVal |= GUILayout.Button(obj.name, NGUIEditorTools.textArea, GUILayout.Width(160f),
				                           GUILayout.Height(20f));
				retVal |= GUILayout.Button(path.Replace("Assets/", ""), NGUIEditorTools.textArea,
				                           GUILayout.Height(20f));
