	...
	public class UIWrapContentEditor : Editor
	{
		public override void OnInspectorGUI()
		{
			...
			SerializedProperty sp1 =
				NGUIEditorTools.DrawProperty("Range Limit", serializedObject, "minIndex", GUILayout.Width(130f));
			NGUIEditorTools.SetLabelWidth(20f);
			SerializedProperty sp2 =
				NGUIEditorTools.DrawProperty("to", serializedObject, "maxIndex", GUILayout.Width(60f));
			NGUIEditorTools.SetLabelWidth(90f);
			...
			if (sp1.intValue != sp2.intValue)
			{
				...
				{
					EditorGUILayout
					   .HelpBox("Limiting indices doesn't play well with UICenterOnChild. You should either not limit the indices, or not use UICenterOnChild.",
					            MessageType.Warning);
				}
			}
		}
