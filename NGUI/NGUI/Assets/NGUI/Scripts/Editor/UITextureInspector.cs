namespace NGUIEditor
{
	...
	[CustomEditor(typeof(NGUITexture), true)]
	public class UITextureInspector : UIBasicSpriteEditor
	{
		...
		protected override bool ShouldDrawProperties()
		{
			...
			EditorGUI.BeginDisabledGroup(mTex == null || mTex.mainTexture == null ||
			...
			if (sp.boolValue != before) (target as NGUIWidget).drawRegion = new Vector4(0f, 0f, 1f, 1f);
		...
		public override bool HasPreviewGUI()
		{
			return (Selection.activeGameObject == null || Selection.gameObjects.Length == 1) &&
			       (mTex                          != null)                                   &&
			       (mTex.mainTexture as Texture2D != null);
		}
