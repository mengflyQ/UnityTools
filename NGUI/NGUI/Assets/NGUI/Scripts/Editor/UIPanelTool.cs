namespace NGUIEditor
{
    ...
    public class UIPanelTool : EditorWindow
    {
        ...
        {
            List<NGUIPanel> panels = NGUIEditorTools.FindAll<NGUIPanel>();
        ...
        bool DrawRow(Entry ent, NGUIPanel selected, bool isChecked)
        {
            ...
            GUILayout.Label(depth, GUILayout.Width(100f));
            ...
            GUILayout.Label(layer, GUILayout.MinWidth(50f));
            GUILayout.Label(widgetCount, GUILayout.MinWidth(50f));
            GUILayout.Label(drawCalls, GUILayout.MinWidth(50f));
            GUILayout.Label(clipping, GUILayout.MinWidth(50f));
            GUILayout.Label(triangles, GUILayout.MinWidth(50f));

            if (ent == null)
            {
                GUILayout.Label("Static", GUILayout.MinWidth(50f));
            }
            else
            {
