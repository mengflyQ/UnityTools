namespace NGUIEditor
{
	...
	static public class NGUIContextMenu
	{
		...
		static void ShowHelp02(MenuCommand command)
		{
			Application.OpenURL("https://discord.gg/tasharen");
		}

		[MenuItem("CONTEXT/NGUIWidget/Copy Widget")]
		static void CopyStyle(MenuCommand command)
		{
			NGUISettings.CopyWidget(command.context as NGUIWidget);
		}

		[MenuItem("CONTEXT/NGUIWidget/Paste Widget Values")]
		static void PasteStyle(MenuCommand command)
		{
			NGUISettings.PasteWidget(command.context as NGUIWidget, true);
		}

		[MenuItem("CONTEXT/NGUIWidget/Paste Widget Style")]
		static void PasteStyle2(MenuCommand command)
		{
			NGUISettings.PasteWidget(command.context as NGUIWidget, false);
		}

		[MenuItem("CONTEXT/NGUIWidget/Help")]
		static void ShowHelp1(MenuCommand command)
		{
			NGUIHelp.Show(command.context);
		}

		[MenuItem("CONTEXT/UIButton/Help")]
		static void ShowHelp2(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIButton));
		}

		[MenuItem("CONTEXT/UIToggle/Help")]
		static void ShowHelp3(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIToggle));
		}

		[MenuItem("CONTEXT/NGUIRoot/Help")]
		static void ShowHelp4(MenuCommand command)
		{
			NGUIHelp.Show(typeof(NGUIRoot));
		}

		[MenuItem("CONTEXT/NGUICamera/Help")]
		static void ShowHelp5(MenuCommand command)
		{
			NGUIHelp.Show(typeof(NGUICamera));
		}

		[MenuItem("CONTEXT/NGUIAnchor/Help")]
		static void ShowHelp6(MenuCommand command)
		{
			NGUIHelp.Show(typeof(NGUIAnchor));
		}

		[MenuItem("CONTEXT/NGUIStretch/Help")]
		static void ShowHelp7(MenuCommand command)
		{
			NGUIHelp.Show(typeof(NGUIStretch));
		}

		[MenuItem("CONTEXT/UISlider/Help")]
		static void ShowHelp8(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UISlider));
		}

		[MenuItem("CONTEXT/NGUI2DSprite/Help")]
		static void ShowHelp9(MenuCommand command)
		{
			NGUIHelp.Show(typeof(NGUI2DSprite));
		}

		[MenuItem("CONTEXT/UIScrollBar/Help")]
		static void ShowHelp10(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIScrollBar));
		}

		[MenuItem("CONTEXT/UIProgressBar/Help")]
		static void ShowHelp11(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIProgressBar));
		}

		[MenuItem("CONTEXT/UIPopupList/Help")]
		static void ShowHelp12(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIPopupList));
		}

		[MenuItem("CONTEXT/NGUIInputField/Help")]
		static void ShowHelp13(MenuCommand command)
		{
			NGUIHelp.Show(typeof(NGUIInputField));
		}

		[MenuItem("CONTEXT/UIKeyBinding/Help")]
		static void ShowHelp14(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIKeyBinding));
		}

		[MenuItem("CONTEXT/UIGrid/Help")]
		static void ShowHelp15(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIGrid));
		}

		[MenuItem("CONTEXT/UITable/Help")]
		static void ShowHelp16(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UITable));
		}

		[MenuItem("CONTEXT/UIPlayTween/Help")]
		static void ShowHelp17(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIPlayTween));
		}

		[MenuItem("CONTEXT/UIPlayAnimation/Help")]
		static void ShowHelp18(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIPlayAnimation));
		}

		[MenuItem("CONTEXT/UIPlaySound/Help")]
		static void ShowHelp19(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIPlaySound));
		}

		[MenuItem("CONTEXT/UIScrollView/Help")]
		static void ShowHelp20(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIScrollView));
		}

		[MenuItem("CONTEXT/UIDragScrollView/Help")]
		static void ShowHelp21(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIDragScrollView));
		}

		[MenuItem("CONTEXT/UICenterOnChild/Help")]
		static void ShowHelp22(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UICenterOnChild));
		}

		[MenuItem("CONTEXT/UICenterOnClick/Help")]
		static void ShowHelp23(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UICenterOnClick));
		}

		[MenuItem("CONTEXT/UITweener/Help")]
		[MenuItem("CONTEXT/UIPlayTween/Help")]
		static void ShowHelp24(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UITweener));
		}

		[MenuItem("CONTEXT/NGUIActiveAnimation/Help")]
		[MenuItem("CONTEXT/UIPlayAnimation/Help")]
		static void ShowHelp25(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIPlayAnimation));
		}
		...
		[MenuItem("CONTEXT/UIScrollView/Help")]
		[MenuItem("CONTEXT/UIDragScrollView/Help")]
		static void ShowHelp26(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIScrollView));
		}

		[MenuItem("CONTEXT/NGUIPanel/Help")]
		static void ShowHelp27(MenuCommand command)
		{
			NGUIHelp.Show(typeof(NGUIPanel));
		}

		[MenuItem("CONTEXT/NGUILocalize/Help")]
		static void ShowHelp28(MenuCommand command)
		{
			NGUIHelp.Show(typeof(NGUILocalize));
		}

		[MenuItem("CONTEXT/Localization/Help")]
		static void ShowHelp29(MenuCommand command)
		{
			NGUIHelp.Show(typeof(Localization));
		}

		[MenuItem("CONTEXT/UIKeyNavigation/Help")]
		static void ShowHelp30(MenuCommand command)
		{
			NGUIHelp.Show(typeof(UIKeyNavigation));
		}

		[MenuItem("CONTEXT/PropertyBinding/Help")]
		static void ShowHelp31(MenuCommand command)
		{
			NGUIHelp.Show(typeof(PropertyBinding));
		}

		public delegate NGUIWidget AddFunc(GameObject go);
		...
		static public void AddChild(object obj)
		{
			...
			NGUIWidget widget                                = func(Selection.activeGameObject);
		...
		{
			AddFunc  func                                  = obj as AddFunc;
			NGUIWidget widget                                = func(Selection.activeTransform.parent.gameObject);
			if (widget != null) Selection.activeGameObject = widget.gameObject;
		}
		...
		static public void AddCommonItems(GameObject target)
		{
			if (target != null)
			{
				NGUIWidget widget = target.GetComponent<NGUIWidget>();

				string myName = string.Format("Selected {0}",
				                              (widget != null) ? NGUITools.GetTypeName(widget) : "Object");
				...
				AddItem("Create/Anchor (Legacy)", false, AddChild<NGUIAnchor>, target);

				if (target.GetComponent<NGUIPanel>() != null)
				{
			...
			if (target.collider != null || target.GetComponent<Collider2D>() != null)
...
#endif
				{
					if (scrollView != null)
					{
						...
						if (target.GetComponent<UICenterOnClick>()           == null &&
						    NGUITools.FindInParents<UICenterOnChild>(target) != null)
						{
					...
					AddItem("Attach/Input Field Script",  false, Attach, typeof(NGUIInputField));
					NGUIContextMenu.AddSeparator("Attach/");
					...
					if (target.GetComponent<UIDragScrollView>() == null)
					{
						for (int i = 0; i < NGUIPanel.list.Count; ++i)
						{
							NGUIPanel pan = NGUIPanel.list[i];
							if (pan.clipping == NGUIDrawCall.Clipping.None) continue;

							UIScrollView dr = pan.GetComponent<UIScrollView>();
							if (dr == null) continue;

							AddItem("Attach/Drag Scroll View", false,
							        delegate(object obj) { target.AddComponent<UIDragScrollView>().scrollView = dr; },
							        null);
				...
				if (target.GetComponent<NGUILocalize>() == null)
					AddItem("Attach/Localization Script", false, Attach, typeof(NGUILocalize));
				...
				else if (target.GetComponent<NGUIPanel>() != null)
				{
					AddMissingItem<TweenAlpha>(target, "Tween/Alpha");
				}
		...
		{
			GameObject go                               = obj as GameObject;
			if (go.GetComponent<NGUIWidget>() != null) go = go.transform.parent.gameObject;
			NGUIPanel panel                               = NGUISettings.AddPanel(go);
		...
		static void AddScrollView(object obj)
		{
			...
			if (go.GetComponent<NGUIWidget>() != null) go = go.transform.parent.gameObject;
			NGUIPanel panel                               = NGUISettings.AddPanel(go);
			panel.clipping = NGUIDrawCall.Clipping.SoftClip;
		...
		static void OnBoxCollider(object obj)
		{
			NGUITools.AddWidgetCollider(obj as GameObject);
		}
