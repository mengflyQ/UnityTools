	...
	public class MinMaxRangeAttributeDrawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label)
		{
			...
			else
			{
				...
				label.text = "";
				EditorGUI.PropertyField(new Rect(rect.x + rect.width - 50f - indent, rect.y + 16f, 50f + indent, 16f),
				                        maxProperty, label);
				...
				GUI.changed = false;
				EditorGUI.MinMaxSlider(new Rect(rect.x + 60f, rect.y + 16f, rect.width - 120f, 16f), ref min, ref max,
				                       range.minLimit, range.maxLimit);
				//--EditorGUI.indentLevel;
