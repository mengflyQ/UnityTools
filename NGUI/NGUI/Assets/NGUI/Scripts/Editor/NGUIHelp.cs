namespace NGUIEditor
{
	...
	static public class NGUIHelp
	{
		...
		{
			if (type == typeof(NGUITexture)) return "http://www.tasharen.com/forum/index.php?topic=6703";
			if (type == typeof(NGUISprite)) return "http://www.tasharen.com/forum/index.php?topic=6704";
			if (type == typeof(NGUIPanel)) return "http://www.tasharen.com/forum/index.php?topic=6705";
			if (type == typeof(NGUILabel)) return "http://www.tasharen.com/forum/index.php?topic=6706";
			...
			if (type == typeof(NGUIRoot)) return "http://www.tasharen.com/forum/index.php?topic=6710";
			if (type == typeof(NGUICamera)) return "http://www.tasharen.com/forum/index.php?topic=6711";
			if (type == typeof(NGUIAnchor)) return "http://www.tasharen.com/forum/index.php?topic=6712";
			if (type == typeof(NGUIStretch)) return "http://www.tasharen.com/forum/index.php?topic=6713";
			if (type == typeof(UISlider)) return "http://www.tasharen.com/forum/index.php?topic=6715";
			if (type == typeof(NGUI2DSprite)) return "http://www.tasharen.com/forum/index.php?topic=6729";
			...
			if (type == typeof(NGUIInputField)) return "http://www.tasharen.com/forum/index.php?topic=6752";
			...
			if (type == typeof(NGUIActiveAnimation) || type == typeof(UIPlayAnimation))
			...
			if (type == typeof(NGUIWidget) || type.IsSubclassOf(typeof(NGUIWidget)))
			...
			if (type == typeof(NGUILocalize) || type == typeof(Localization))
