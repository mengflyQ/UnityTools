namespace NGUI
{
	...
	[AddComponentMenu("NGUI/Internal/NGUIActiveAnimation")]
	public class NGUIActiveAnimation : MonoBehaviour
	{
		/// <summary>
		/// Active animation that resulted in the event notification.
		/// </summary>

		static public NGUIActiveAnimation current;
			...
			if (mAnim != null)
			{
				...
				foreach (AnimationState state in mAnim)
				{
					if (string.IsNullOrEmpty(clipName) || state.name == clipName)
					{
						...
						if (playDirection == Direction.Reverse && state.time == 0f)
		...
		static public NGUIActiveAnimation Play(Animation       anim, string clipName,
		                                       ...
		                                       EnableCondition enableBeforePlay, DisableCondition disableCondition)
		{
			...
			NGUIActiveAnimation aa = anim.GetComponent<NGUIActiveAnimation>();
			if (aa == null) aa     = anim.gameObject.AddComponent<NGUIActiveAnimation>();
			aa.mAnim             = anim;
		...
		static public NGUIActiveAnimation Play(Animation anim, string clipName, Direction playDirection)
		{
		...
		static public NGUIActiveAnimation Play(Animation anim, Direction playDirection)
		{
		...
		static public NGUIActiveAnimation Play(Animator        anim, string clipName,
		                                       Direction       playDirection,
		                                       EnableCondition enableBeforePlay, DisableCondition disableCondition)
		{
