namespace NGUI
{
	...
	[AddComponentMenu("NGUI/Internal/NGUISpringPanel")]
	public class NGUISpringPanel : MonoBehaviour
	{
		static public NGUISpringPanel current;
		...
		[System.NonSerialized] NGUIPanel      mPanel;
		...
		static public NGUISpringPanel Begin(GameObject go, Vector3 pos, float strength)
		{
			var sp             = go.GetComponent<NGUISpringPanel>();
			if (sp == null) sp = go.AddComponent<NGUISpringPanel>();
			sp.target     = pos;
		...
		static public NGUISpringPanel Stop(GameObject go)
		{
			var sp = go.GetComponent<NGUISpringPanel>();
