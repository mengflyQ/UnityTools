namespace NGUI
{
    ...
    /// Using it is simple: text = Localization.Get(key), or just add a NGUILocalize script to your labels.
    ...
    static public class Localization
    {
        ...
        static public bool LoadCSV(TextAsset asset, bool merge = false)
        {
        ...
        static public bool LoadCSV(byte[] bytes, bool merge = false)
        {
        ...
        static string[] ExtractStrings(BetterList<string> added, string[] newLanguages,
        ...
        static public bool Has(string key)
        {
            ...
            var scheme = NGUICamera.currentScheme;

            if (scheme == NGUICamera.ControlScheme.Touch)
            {
            ...
            else if (scheme == NGUICamera.ControlScheme.Controller)
            {
...
#if UNITY_EDITOR
        [System.NonSerialized] static HashSet<string> mIgnoreMissing = null;
#endif
