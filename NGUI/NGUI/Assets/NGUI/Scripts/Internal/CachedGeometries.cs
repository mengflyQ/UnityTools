namespace NGUI
{
    ...
    public class CachedGeometries
    {
        ...
        public static void PushToCachedGeometries(NGUIGeometry geometry)
        {
        ...
        public static void PullFromCachedGeometries(int vertexCount, NGUIGeometry geometry)
        {
