...
namespace NGUI
{
	...
	public class EventDelegate
	{
		...
		public bool isValid
		{
			...
			if (!mCached) Cache();
#endif
				return (mRawDelegate && mCachedCallback != null) ||
				       (mTarget                         != null && !string.IsNullOrEmpty(mMethodName));
			}
		}
...
#else
						mCachedCallback =
							(Callback) System.Delegate.CreateDelegate(typeof(Callback), mTarget, mMethodName);
#endif
