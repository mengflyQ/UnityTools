namespace NGUI
{
    ...
    [ExecuteInEditMode]
    [AddComponentMenu("NGUI/Event/Toggle")]
    public class UIToggle : UIWidgetContainer
    {
        ...
        public NGUIWidget activeSprite;
        ...
        [HideInInspector] [SerializeField] NGUISprite checkSprite = null;
        ...
        void OnClick()
        {
            if (enabled && isColliderEnabled && NGUICamera.currentTouchID != -2) value = !value;
        }
        ...
        public void Set(bool state, bool notify = true)
        {
            ...
            else if (mIsActive != state)
            {
                ...
                if (activeSprite != null)
                {
                    ...
                    {
                        TweenAlpha.Begin(activeSprite.gameObject, 0.15f,
                                         invertSpriteState ? (mIsActive ? 0f : 1f) : (mIsActive ? 1f : 0f));
                    }
                }
                ...
                if (animator != null)
                {
                    NGUIActiveAnimation aa = NGUIActiveAnimation.Play(animator, null,
                ...
                {
                    NGUIActiveAnimation aa = NGUIActiveAnimation.Play(activeAnimation, null,
                                                                      state ? Direction.Forward : Direction.Reverse,
                                                                      EnableCondition.IgnoreDisabledState,
                                                                      DisableCondition.DoNotDisable);
                    if (aa != null && (instantTween || !NGUITools.GetActive(this))) aa.Finish();
