namespace NGUI
{
	...
	[AddComponentMenu("NGUI/Event/Drag-Resize Widget")]
	public class UIDragResize : MonoBehaviour
	{
		...
		public NGUIWidget target;

		/// <summary>
		/// Widget's pivot that will be dragged
		/// </summary>

		public NGUIWidget.Pivot pivot = NGUIWidget.Pivot.BottomRight;
		...
		void OnDrag(Vector2 delta)
		{
			if (mDragging && target != null)
			{
				...
				if (mPlane.Raycast(ray, out dist))
				{
					...
					// Adjust the widget
					NGUIMath.ResizeWidget(target, pivot, localDelta.x, localDelta.y, minWidth, minHeight, maxWidth,
					                      maxHeight);
