namespace NGUI
{
	...
	/// In most cases you should use NGUIEventListener script instead. For example:
	/// NGUIEventListener.Get(gameObject).onClick += MyClickFunction;
	/// </summary>

	[AddComponentMenu("NGUI/Event/Forward Events (Legacy)")]
