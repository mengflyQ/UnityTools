namespace NGUI
{
    ...
    [RequireComponent(typeof(NGUILabel))]
    [AddComponentMenu("NGUI/Effect/Typewriter Effect")]
        ...
        void Update()
        {
            ...
            while (mCurrentOffset < len && mNextChar <= RealTime.time)
            {
                ...
                else if (lastOffset + 1 == len || mFullText[lastOffset + 1] <= ' ')
                {
                    if (c == '.')
                    {
                        if (lastOffset + 2 < len && mFullText[lastOffset + 1] == '.' &&
                ...
                else
                {
                    ...
                    mLabel.text = keepFullDimensions
                                      ? mFullText.Substring(0, mCurrentOffset) + "[00]" +
            ...
            else if (mFade.Size != 0)
            {
                ...
                if (mFade.Size == 0)
                {
                    ...
                    {
                        mLabel.text = mFullText.Substring(0, mCurrentOffset) + "[00]" +
                                      mFullText.Substring(mCurrentOffset);
                    }
