namespace NGUI
{
	...
	[AddComponentMenu("NGUI/Event/Wrap Content")]
	public class UIWrapContent : MonoBehaviour
	{
		...
		/// <summary>
		/// Initialize everything and register a callback with the NGUIPanel to be notified when the clipping region moves.
		/// </summary>
		...
		/// <summary>
		/// Callback triggered by the NGUIPanel when its clipping region moves (for example when it's being scrolled).
		/// </summary>
