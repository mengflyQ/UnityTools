...
// Unisip, zh4ox, Mudwiz, Nicki, DarkMagicCK.
	...
	public interface INGUIFont
	{
		...
		NGUISpriteData GetSprite(string spriteName);
	...
	public class NGUIFont : ScriptableObject, INGUIFont
	{
		...
		// Cached value
		[System.NonSerialized] NGUISpriteData mSprite = null;
		...
		public NGUISpriteData GetSprite(string spriteName)
		{
			var ia = atlas;
		...
		{
			get { return premultipliedAlphaShader; }
		}
		...
		public void MarkAsChanged()
		{
			...
			for (int i = 0, imax = labels.Length; i < imax; ++i)
			{
				...
				if (lbl.enabled && NGUITools.GetActive(lbl.gameObject) &&
				    NGUITools.CheckIfRelated(this, lbl.bitmapFont as INGUIFont))
				{
		...
		public void AddSymbol(string sequence, string spriteName)
		{
			...
			if (rep != null)
			{
				rep.AddSymbol(sequence, spriteName);
				return;
			}
