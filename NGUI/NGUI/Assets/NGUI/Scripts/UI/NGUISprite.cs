namespace NGUI
{
    ...
    [ExecuteInEditMode]
    [AddComponentMenu("NGUI/UI/NGUISprite")]
    public class NGUISprite : NGUIBasicSprite
    {
        ...
        [System.NonSerialized] protected NGUISpriteData mSprite;
        ...
        public override Vector4 border
        {
            get
            {
                NGUISpriteData sp = GetAtlasSprite();
        ...
        public NGUISpriteData GetAtlasSprite()
        {
        ...
        protected void SetAtlasSprite(NGUISpriteData sp)
        {
            mChanged = true;
            mSpriteSet = true;
