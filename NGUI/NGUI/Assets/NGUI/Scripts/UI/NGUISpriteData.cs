namespace NGUI
{
	...
	public class NGUISpriteData
	{
		...
		{
			get { return (paddingLeft | paddingRight | paddingTop | paddingBottom) != 0; }
		}
		...
		public void CopyFrom(NGUISpriteData sd)
		{
			name = sd.name;
		...
		public void CopyBorderFrom(NGUISpriteData sd)
		{
			borderLeft   = sd.borderLeft;
			borderRight  = sd.borderRight;
			borderTop    = sd.borderTop;
