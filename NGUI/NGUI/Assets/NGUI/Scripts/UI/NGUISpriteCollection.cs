namespace NGUI
{
    ...
    [ExecuteInEditMode]
    [AddComponentMenu("NGUI/UI/NGUISpriteCollection")]
    public class NGUISpriteCollection : NGUIBasicSprite
    {
        /// <summary>
        ...
        [System.NonSerialized] NGUISpriteData mSprite;
        ...
        {
            get { return mAtlas as INGUIAtlas; }
            set
            {
        ...
        public override void OnFill(BetterList<Vector3> verts, BetterList<Vector2> uvs, BetterList<Color32> cols)
        {
            ...
            foreach (var pair in mSprites)
            {
                ...
                var inner = new Rect(mSprite.x + mSprite.borderLeft,
                                     mSprite.y + mSprite.borderTop,
                ...
                if (ent.rot != 0f)
                {
                    ...
                    {
                        var pos = verts.Buffer[i];
                        pos = new Vector3((1f - num6) * pos.x - num12 * pos.y, num12 * pos.x + (1f - num6) * pos.y,
                                          pos.z);
                        pos.x += ent.pos.x;
                        pos.y += ent.pos.y;
                        verts.Buffer[i] = pos;
        ...
        public void AddSprite(object id, string spriteName, Vector2 pos, float width, float height, Color32 color,
                              Vector2 pivot,
        ...
        {
            return GetCurrentSpriteID(NGUICamera.lastWorldPosition);
        }
        ...
        {
            return GetCurrentSprite(NGUICamera.lastWorldPosition);
        }
        ...
        protected void OnHover(bool isOver)
        {
            if (onHover != null)
            {
                if (isOver)
                {
                    NGUICamera.onMouseMove += OnMove;
                    OnMove(Vector2.zero);
                }
                else NGUICamera.onMouseMove -= OnMove;
            }
        }
        ...
        {
            if (onDrag != null && mLastPress != null) onDrag(mLastPress, delta);
        }
