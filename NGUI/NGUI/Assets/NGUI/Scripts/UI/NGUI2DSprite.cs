namespace NGUI
{
    ...
    public class NGUI2DSprite : NGUIBasicSprite
    {
        ...
        public override Vector4 drawingDimensions
        {
            get
            {
                ...
                if (mSprite != null && mType != NGUISprite.Type.Tiled)
                {
                    ...
                    int padRight =
                        Mathf.RoundToInt(mSprite.rect.width - mSprite.textureRect.width - mSprite.textureRectOffset.x);
                    int padTop = Mathf.RoundToInt(mSprite.rect.height - mSprite.textureRect.height -
                                                  mSprite.textureRectOffset.y);
