namespace NGUI
{
	...
	[AddComponentMenu("NGUI/UI/NGUITooltip")]
	public class NGUITooltip : MonoBehaviour
	{
		static protected NGUITooltip mInstance;

		public Camera     uiCamera;
		public NGUILabel    text;
		public GameObject tooltipRoot;
		public NGUISprite   background;
		...
		{
			get { return (mInstance != null && mInstance.mTarget == 1f); }
		}
		...
		{
			mTrans   = transform;
			mWidgets = GetComponentsInChildren<NGUIWidget>();
		...
		{
			if (mTooltip != NGUICamera.tooltipObject)
			{
				mTooltip = null;
				mTarget  = 0f;
			}
		...
		protected virtual void SetText(string tooltipText)
		{
			...
			{
				mTarget   = 1f;
				mTooltip  = NGUICamera.tooltipObject;
				text.text = tooltipText;

				// Orthographic camera positioning is trivial
				mPos = NGUICamera.lastEventPosition;
		...
		[System.Obsolete("Use NGUITooltip.Show instead")]
