namespace NGUI
{
	...
	public class TweenAlpha : UITweener
	{
		...
		[Tooltip("Color to adjust")] public string colorProperty;

		[System.NonSerialized] bool           mCached = false;
		[System.NonSerialized] NGUIRect         mRect;
		...
		void Cache()
		{
			...
			if (mRect == null && mSr == null)
			{
				...
				if (mLight == null)
				{
					...
					if (mMat == null) mRect = GetComponentInChildren<NGUIRect>();
				}
