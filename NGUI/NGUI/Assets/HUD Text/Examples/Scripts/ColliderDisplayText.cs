...
public class ColliderDisplayText : MonoBehaviour
{
	...
	void OnClick ()
	{
		if (mText != null)
		{
			if (NGUICamera.currentTouchID == -1) mText.Add(-10f + Random.value * -10f, Color.red, 0f);
			else if (NGUICamera.currentTouchID == -2) mText.Add(10f + Random.value * 10f, Color.green, 0f);
		}
	}
}
