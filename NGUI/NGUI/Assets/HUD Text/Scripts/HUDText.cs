...
public class HUDText : MonoBehaviour
{
	protected class Entry
	{
		...
		public NGUILabel label;		// Label on the game object
	...
	public NGUILabel.Effect effect = NGUILabel.Effect.None;
	...
	Entry Create ()
	{
		...
		ne.label = NGUITools.AddWidget<NGUILabel>(gameObject);
		...
		ne.label.overflowMethod = NGUILabel.Overflow.ResizeFreely;
