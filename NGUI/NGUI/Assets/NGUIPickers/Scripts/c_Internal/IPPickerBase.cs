...
public abstract class IPPickerBase : MonoBehaviour {
	...
	public NGUI.NGUIWidget.Pivot 	widgetsPivot = NGUI.NGUIWidget.Pivot.Center;
	...
	public abstract NGUI.NGUIWidget GetCenterWidget ();
	
	public abstract NGUI.NGUIWidget GetWidgetAtScreenPos ( Vector2 pos );
