...
public class PickerPopper : MonoBehaviour 
{
	...
	public NGUI.NGUIWidget pickerBackground;
	public NGUI.NGUIPanel cyclerPanel;
	...
	public NGUI.NGUIWidget widgetForBlinkConfirmation;
	...
	void Start ()
	{
		...
		_scaleTween = pickerBackground.gameObject.GetComponent ( typeof ( NGUI.TweenHeight ) ) as NGUI.TweenHeight;
	...
	public IEnumerator OpenPicker ()
	{
		...
		NGUI.EventDelegate.Set ( _clipRangeTween.onFinished, OnTweenClipRangeFinished );
