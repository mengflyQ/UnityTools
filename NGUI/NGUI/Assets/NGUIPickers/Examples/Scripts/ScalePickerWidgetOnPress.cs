...
public class ScalePickerWidgetOnPress : MonoBehaviour {
	...
	void OnPress ( bool press )
	{
		if ( press )
		{
			...
			_tweenScale = _widget.gameObject.GetComponent ( typeof ( NGUI.TweenScale ) ) as NGUI.TweenScale;
			if ( _tweenScale == null )
			{
	...
	{
		_tweenScale = _widget.gameObject.AddComponent ( typeof ( NGUI.TweenScale ) ) as NGUI.TweenScale;
