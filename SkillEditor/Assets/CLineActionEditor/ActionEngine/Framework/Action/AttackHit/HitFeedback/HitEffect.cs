...
namespace CAE.Core
{
    ...
    {
        private string mEffect = string.Empty;
        private string mEffectCritical = string.Empty;
        private string mEffectBlock = string.Empty;
        private Vector3 mEffectOffset = Vector3.zero;
        
        #region property
        [EditorProperty("受击特效", EditorPropertyType.EEPT_GameObjectToString)]
        public string Effect
        {
            get { return mEffect; }
            set { mEffect = value; }
        }
        [EditorProperty("暴击特效", EditorPropertyType.EEPT_GameObjectToString)]
        public string EffectCritical
        {
            get { return mEffectCritical; }
            set { mEffectCritical = value; }
        }
        [EditorProperty("格挡特效", EditorPropertyType.EEPT_GameObjectToString)]
