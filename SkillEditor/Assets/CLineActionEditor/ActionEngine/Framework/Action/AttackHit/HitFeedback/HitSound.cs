...
namespace CAE.Core
{
    ...
    {
        private string mSound = string.Empty;
        private int mSoundCount = 1;
        private string mSoundCritical = string.Empty;
        private int mSoundCriticalCount = 1;
        private string mSoundBlock = string.Empty;
        private int mSoundBlockCount = 1;
        
        #region property
        [EditorProperty("受击音效", EditorPropertyType.EEPT_GameObjectToString)]
        public string Sound
        {
            get { return mSound; }
            set { mSound = value; }
        ...
        [EditorProperty("暴击音效", EditorPropertyType.EEPT_GameObjectToString)]
        ...
        [EditorProperty("格挡音效", EditorPropertyType.EEPT_GameObjectToString)]
