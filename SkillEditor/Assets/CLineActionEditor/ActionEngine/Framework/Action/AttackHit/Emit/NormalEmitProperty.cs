...
namespace CAE.Core
{
    ...
    {
        protected EEmitterPosType mPosType = EEmitterPosType.EEPT_None;
        protected string mDummy = string.Empty;
        protected Vector3 mEmitOffset = Vector3.zero;
        protected Vector3 mEmitRotation = Vector3.zero;
