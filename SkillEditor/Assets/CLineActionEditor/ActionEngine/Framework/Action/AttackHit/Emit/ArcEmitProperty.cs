...
namespace CAE.Core
{
    ...
    {
        private EEmitterPosType mPosType = EEmitterPosType.EEPT_None;
        private string mDummy = string.Empty;
        private EArcEmitType mEmitType = EArcEmitType.EAE_Circle;
        private int mIntervalDegree = 30;
        private float mRadiusOffset = 0.0f;
