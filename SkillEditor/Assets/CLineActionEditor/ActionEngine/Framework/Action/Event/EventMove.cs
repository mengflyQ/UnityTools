...
namespace CAE.Core
{
    ...
    public class EventMove : EventData
    {
        private bool mIgnorMove = false;
        private bool mResetVelocity = true;
        private EMoveDirectionType mMoveDirType = EMoveDirectionType.EMDT_Custom;
        private Vector3 mCustomDirection = Vector3.zero;
        private EMoveSpeedType mMoveSpeedType = EMoveSpeedType.EMST_Custom;
        private float mCustomSpeed = 0f;
        private float mAnimDist = 0f;
        private float mAnimTime = 0f;
        private bool mResetAcc = true;
        private Vector3 mAcc = Vector3.zero;
        ...
        {
            get { return EEventType.EET_Move; }
        }
