...
namespace CAE.Core
{
    ...
    public sealed class WeaponProperty : IProperty
    {
        ...
        private string mSetupAction;
        private string mManShowAction;
        private string mWomanShowAction;
        private string mAttachDummyIdle;
        private string mAttachDummyAttackL;
        private string mAttachDummyAttackR;
        private Vector3 mPositionOffset;
        private EWeaponType mWeaponType;
        private bool mIsDribble;
        private EDeadType mDeadType = EDeadType.EDT_NormalOrExplosion;
        private string mShowPrefab;
        ...
        [EditorProperty("展示模型", EditorPropertyType.EEPT_GameObjectToString)]
        public string ShowPrefab
        {
            get { return mShowPrefab; }
            set { mShowPrefab = value; }
        }
        [EditorProperty("预加载动作", EditorPropertyType.EEPT_StringList)]
